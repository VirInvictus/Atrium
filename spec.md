...
**Version:** 0.7.6 (Phase 15.75 complete; v0.6.x screenshot-cleanup arc complete; v0.6.18 efficiency pass; v0.6.19 roadmap revision retiring the Things 3 import phase, promoting Org-mode + Todoist to first-class import slots, and adding Phase 19.5 — productivity essentials surfaced by the gap-analysis pass against Errands / Planify / Endeavour / Things 3 / OmniFocus / Taskwarrior / Todoist; v0.7.0 visual-fusion + whitespace polish pass; v0.7.1 surface continuity follow-up; v0.7.2 Review canonical page absorbs the Weekly Review perspective + sidebar "Lists" auto-title retired; v0.7.3 inspector check-off + perspective editor dialog; v0.7.4 task-level Mark Reviewed via migration 0006 + per-row button on the weekly walk + 7-day exclusion; v0.7.5 visual refinement pass — tag pills, inspector empty state, filter ghost, row separators, sidebar selection; v0.7.6 Phase 16 foundation — sync module skeleton + atomic-write helper + vault-path GSettings key, with the Org parser hand-rolled into atrium-core::sync::org over the v0.7.7+ patch arc rather than taking a third-party dep)
