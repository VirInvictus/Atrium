...
```bash
cargo test --workspace            # all tests (989 at v0.72.3; the v0.70.0 vir-search extraction moved the search suite out of the workspace)
