...
```bash
cargo test --workspace            # all tests (996 at v0.73.0; the v0.70.0 vir-search extraction moved the search suite out of the workspace)
