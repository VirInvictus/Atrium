...
**Current release: v0.48.0** (July 2026). **Schema version: 19** (migrations `0001` → `0019`). **1027 unit tests across the workspace, all green.**
