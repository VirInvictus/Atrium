...
└── src/db/
    ...
    └── migrations/                   ← 0001 initial → 0015 area_default_review_interval; user_version PRAGMA currently 15
