...
```bash
cargo test --workspace            # all tests (974 at v0.27.0)
...
└── src/db/
    ...
    └── migrations/                   ← 0001 initial → 0017 task_template; user_version PRAGMA currently 17
