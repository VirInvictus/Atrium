...
- [ ] Follow-on (same scaffolding, future minor cuts): Taskwarrior `task export` JSON, todo.txt, and the unified import dialog (worker-run parse + pre-import report + batch commit).
